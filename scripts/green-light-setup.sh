#!/usr/bin/env bash
# green-light-setup — runs as root via pkexec (polkit action
...
# system paths.
#
# Usage: green-light-setup <stage-dir>
...
echo "green-light-setup: installed"
